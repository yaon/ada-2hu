...
with STM32F4.SYSCONFIG_Control;
...
package body STM32F4.GPIO is
   ...
   function Is_Any_Set (Port : GPIO_Port;  Pins : GPIO_Pins) return Boolean is
   ...
   function Is_Set (Port : GPIO_Port;  Pin : GPIO_Pin) return Boolean is
   begin
      return (Port.IDR and Pin'Enum_Rep) /= 0;
   end Is_Set;
...
--        Temp := Port.LCKR;
   ...
   is
      use STM32F4.SYSCONFIG_Control, STM32F4.Reset_Clock_Control;
   begin
      SYSCFG_Clock_Enable;

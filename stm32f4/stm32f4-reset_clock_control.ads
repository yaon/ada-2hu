...
package STM32F4.Reset_Clock_Control is
   ...
   function Get_Clock_Frequency return RCC_Clock;
...
private
   ...
   type RCC_Registers is record
      ...
      PLLSAICFGR  : Word;  --  RCC PLLSAI configuration register at 16#88#
      DCKCFGR     : Word;  --  RCC DCK configuration register at 16#8C#
   end record
     with Volatile;
   ...
   --  SWS configuration
   SWS   : constant := 16#0000000C#;         --  SWS[1:0] bits (System Clock Switch Status)
   SWS_0 : constant := 16#00000004#;         --  Bit 0
   SWS_1 : constant := 16#00000008#;         --  Bit 1

   SWS_HSI : constant := 16#00000000#;         --  HSI oscillator used as system clock
   SWS_HSE : constant := 16#00000004#;         --  HSE oscillator used as system clock
   ...
   --  PPRE1 configuration
   PPRE1   : constant := 16#00001C00#;         --  PRE1[2:0] bits (APB1 prescaler)
   ...
   --  PPRE2 configuration
   PPRE2   : constant := 16#0000E000#;         --  PRE2[2:0] bits (APB2 prescaler)
